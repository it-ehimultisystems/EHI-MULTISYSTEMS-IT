...
export const AirlineLogoPDF = ({ airline, width = 80 }: { airline: string; width?: number }) => {
  ...
  if (norm.includes('aero')) {
    return (
      <View style={{ width, alignItems: 'center' }}>
        <Text style={{ fontSize: width * 0.4, color: '#000000', fontWeight: 'heavy' }}>aero</Text>
  ...
  if (norm.includes('arik')) {
    return (
      <View style={{ width, alignItems: 'center', flexDirection: 'row' }}>
        <Text style={{ fontSize: width * 0.45, color: '#000000', fontWeight: 'heavy', fontStyle: 'italic' }}>Arik</Text>
    ...
    return (
      <View style={{ width, alignItems: 'center' }}>
        <View style={{ flexDirection: 'row', alignItems: 'flex-end' }}>
          ...
          <Text style={{ fontSize: width * 0.35, color: '#000000', fontWeight: 'heavy' }}>Jet</Text>
        </View>
  ...
  if (norm.includes('united') || norm.includes('un')) {
    return (
      <View style={{ width, alignItems: 'center' }}>
        ...
        <Text style={{ fontSize: width * 0.25, color: '#000000', fontWeight: 'heavy', marginTop: -width * 0.22, paddingBottom: width * 0.1 }}>un</Text>
        <Text style={{ fontSize: width * 0.1, color: '#000000', fontWeight: 'heavy', marginTop: width * 0.05 }}>UNITED NIGERIA</Text>
      </View>
    );
  }
  ...
  return (
    <View style={{ width, alignItems: 'center' }}>
      <Text style={{ fontSize: width * 0.15, color: '#000000', fontWeight: 'heavy', textAlign: 'center' }}>{airline.toUpperCase()}</Text>
    </View>
  );
};
